...
def contador_vocales_refactor():
            ...
            for vocal, cantidad, plural in vocales:
                if cantidad == 1:

                    print(f"La frase contiene 1 letra '{vocal}'")

                elif cantidad > 1:

                    print(f"La frase contiene {cantidad} letras '{vocal}'")
